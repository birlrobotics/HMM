...
def assess_threshold_and_decide(
    ...
    output_dir = os.path.join(figure_save_path, 'threshold_for_deri_of_diff')
...
def run(model_save_path, 
    ...
    if len(threshold_group_by_state) != 0:
        joblib.dump(threshold_group_by_state, model_save_path+"/threshold_for_deri_of_diff.pkl")
        joblib.dump(mean_curve_group_by_state, model_save_path+"/mean_curve_group_by_state.pkl")
